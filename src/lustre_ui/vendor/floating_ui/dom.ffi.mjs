import {
  rectToClientRect,
  arrow as arrow$1,
  autoPlacement as autoPlacement$1,
  detectOverflow as detectOverflow$1,
  flip as flip$1,
  hide as hide$1,
  inline as inline$1,
  limitShift as limitShift$1,
  offset as offset$1,
  shift as shift$1,
  size as size$1,
  computePosition as computePosition$1,
} from "./core.ffi.mjs";
import { round, createCoords, max, min, floor } from "./utils.ffi.mjs";
import {
  getComputedStyle as getComputedStyle$1,
  isHTMLElement,
  isElement,
  getWindow,
  isWebKit,
  ...
  isTableElement,
  getContainingBlock,
} from "./dom-utils.ffi.mjs";
export { getOverflowAncestors } from "./dom-utils.ffi.mjs";
